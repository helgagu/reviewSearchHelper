...
public class BinsearchResultsEntityManager {
     ...
     * @return binsearchResults with the values
     */
    ...
    /**
     * Add the search parameter arguments to the binsearchresults object
     * @param bin the binsearchResult object to add the search parameters to
     ...
     * @param sort search parameter sort, sort = relevancerank : by how many times mentioned in description, title etc...@param availability
     * @param requestTimestamp  the timestamp of the request from the response
     * @return binsearchresult object with the values
     */
    public BinsearchResults addSearchParamsBinsearchResults(BinsearchResults bin,
                                                            String availability,
                                                            String browseNodeId,
                                                            String merchantId,
                                                            String powerSearch,
